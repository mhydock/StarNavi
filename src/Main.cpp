...
void buildGUI()
{
	...
	Container *c1 = new Container(sm,f_sm,150,30,500,500);
	c1->setCorners(false,true,false,true);
	c1->setCornerRadius(10);
	c1->setFilled(true);
	c1->setLined(false);
	c1->setFillColor(0,0,0,1);
...
//==============================================================================
	...
	DrawableList *bl = new DrawableList(0,0,145,0);
	...
	Button *back = new Button("<--",f_back,0,0,145,30);
	bl->addDrawable(back);
	...
	Button *tags = new Button("By Tags",f_tags,0,0,145,30);
	bl->addDrawable(tags);
	...
	Container *c2 = new Container(bl,f_bl,0,0,145,530);
	c2->setCorners(false,true,false,false);
	c2->setCornerRadius(10);
	c2->setFilled(true);
	c2->setLined(false);
	c2->setFillColor(.1,.1,.1,.5);
...
//==============================================================================
	...
	Container *c3 = new Container(NULL,new NullFunctor(),655,0,145,530);
	c3->setCorners(true,false,false,false);
	c3->setCornerRadius(10);
	c3->setFilled(true);
	c3->setLined(false);
	c3->setFillColor(.1,.1,.1,.5);
	...
	Container *c5 = new Container(sb,new NullFunctor(),150,5,500,20);
	c5->setFillColor(.1,.1,.1,.5);
	c5->setFilled(true);
	c5->setLined(false);
